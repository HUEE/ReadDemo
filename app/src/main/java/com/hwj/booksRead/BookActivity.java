...
public class BookActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		pagefactory = new BookPageFactory(w, h,myContext); 
...
//	}
	...
	public void itemDig(){
		...
		new com.hwj.widget.ActionSheetDialog(BookActivity.this)
		.builder()
		.setTitle("请选择章节")
		.setCancelable(false)
		.setCanceledOnTouchOutside(false)
				.addSheetItem(str[0], com.hwj.widget.ActionSheetDialog.SheetItemColor.Blue,
						new com.hwj.widget.ActionSheetDialog.OnSheetItemClickListener() {
					@Override
				...
				.addSheetItem(str[1], com.hwj.widget.ActionSheetDialog.SheetItemColor.Blue,
						new com.hwj.widget.ActionSheetDialog.OnSheetItemClickListener() {
					@Override
					public void onClick(int which) {
						Toast.makeText(BookActivity.this,
				...
				.addSheetItem(str[2], com.hwj.widget.ActionSheetDialog.SheetItemColor.Blue,
						new com.hwj.widget.ActionSheetDialog.OnSheetItemClickListener() {
					@Override
					public void onClick(int which) {
						Toast.makeText(BookActivity.this,
				...
				.addSheetItem(str[3], com.hwj.widget.ActionSheetDialog.SheetItemColor.Blue,
						new com.hwj.widget.ActionSheetDialog.OnSheetItemClickListener() {
					@Override
					public void onClick(int which) {
						Toast.makeText(BookActivity.this,
				...
				.addSheetItem(str[4], com.hwj.widget.ActionSheetDialog.SheetItemColor.Blue,
						new com.hwj.widget.ActionSheetDialog.OnSheetItemClickListener() {
					@Override
					public void onClick(int which) {
						Toast.makeText(BookActivity.this,
				...
				.addSheetItem(str[5], com.hwj.widget.ActionSheetDialog.SheetItemColor.Blue,
						new com.hwj.widget.ActionSheetDialog.OnSheetItemClickListener() {
					@Override
					public void onClick(int which) {
						Toast.makeText(BookActivity.this,
				...
				.addSheetItem(str[6], com.hwj.widget.ActionSheetDialog.SheetItemColor.Blue,
						new com.hwj.widget.ActionSheetDialog.OnSheetItemClickListener() {
					@Override
					public void onClick(int which) {
						Toast.makeText(BookActivity.this,
				...
				.addSheetItem(str[7], com.hwj.widget.ActionSheetDialog.SheetItemColor.Blue,
						new com.hwj.widget.ActionSheetDialog.OnSheetItemClickListener() {
					@Override
					public void onClick(int which) {
						Toast.makeText(BookActivity.this,
				...
				.addSheetItem(str[8], com.hwj.widget.ActionSheetDialog.SheetItemColor.Blue,
						new com.hwj.widget.ActionSheetDialog.OnSheetItemClickListener() {
					@Override
					public void onClick(int which) {
						Toast.makeText(BookActivity.this,
				...
				.addSheetItem(str[9], com.hwj.widget.ActionSheetDialog.SheetItemColor.Blue,
						new com.hwj.widget.ActionSheetDialog.OnSheetItemClickListener() {
					@Override
					public void onClick(int which) {
						Toast.makeText(BookActivity.this,
	...
	public void dialog(){
		new com.hwj.widget.AlertDialog(BookActivity.this).builder().setTitle("继续阅读")
