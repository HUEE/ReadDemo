...
public class PageWidget extends View {
    ...
    private static final int TOUPYES = 3;
    private static final int TOUPNO = 4;
    ...
    public int doTouchEvent(MotionEvent event) {
        ...
        if (event.getAction() == MotionEvent.ACTION_MOVE) {
            ...
            mTouch.y = event.getY();
            this.postInvalidate();
            if (mTouch.x - downX > 15 && loadpageflag) {
                loadpageflag = false;
                return TORIGHT;
            }
            if (mTouch.x - downX < -15 && loadpageflag) {
